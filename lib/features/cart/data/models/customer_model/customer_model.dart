...
class CustomerModel {
  ...
  @override
  String toString() {
    return 'CustomerModel(id: $id, object: $object, address: $address, balance: $balance, created: $created, currency: $currency, defaultSource: $defaultSource, delinquent: $delinquent, description: $description, discount: $discount, email: $email, invoicePrefix: $invoicePrefix, invoiceSettings: $invoiceSettings, livemode: $livemode, metadata: $metadata, name: $name, nextInvoiceSequence: $nextInvoiceSequence, phone: $phone, preferredLocales: $preferredLocales, shipping: $shipping, taxExempt: $taxExempt, testClock: $testClock)';
  }
